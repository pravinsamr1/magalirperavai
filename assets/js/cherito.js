(function ($) {
  ...
  // Date Picker
  if ($(".cherito-datepicker").length) {
    $(".cherito-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  let cheritoImagePopupGallery = $(".cherito-image-popup");
  cheritoImagePopupGallery.each(function () {
    let elm = $(this);
  ...
  //accordion
  if ($(".cherito-accordion").length) {
    var accordionGrp = $(".cherito-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".cherito-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".cherito-accordion." + accordionName)
                .find(".accordion")
  ...
  function thmOwlInit() {
    // owl slider
    let cheritoowlCarousel = $(".cherito-owl__carousel");
    if (cheritoowlCarousel.length) {
      cheritoowlCarousel.each(function () {
        let elm = $(this);
    ...
    let cheritoowlCarouselNav = $(".cherito-owl__carousel--custom-nav");
    if (cheritoowlCarouselNav.length) {
      cheritoowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let cheritoowlCarouselCustomDots = $(".cherito-owl__carousel--custom-dots");
    if (cheritoowlCarouselCustomDots.length) {
      cheritoowlCarouselCustomDots.each(function () {
        let elm = $(this);
        let cheritoowlCarouselThumb = elm.data("thumb-elm");
        $(cheritoowlCarouselThumb).each(function () {
          let self = $(this);
  ...
  function cheritoSlickInit() {
    // slick slider
    let cheritoslickCarousel = $(".cherito-slick__carousel");
    if (cheritoslickCarousel.length) {
      cheritoslickCarousel.each(function () {
        let elm = $(this);
        let options = elm.data("slick-options");
        let cheritoslickCarousel = elm.slick(
          "object" === typeof options ? options : JSON.parse(options)
        );
      });
    }
  ...
  //Strech Column
  function cherito_stretch() {
    var i = $(window).width();
    $(".row .cherito-stretch-element-inside-column").each(function () {
      var $this = $(this),
